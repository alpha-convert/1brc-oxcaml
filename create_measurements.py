...
def build_test_data(weather_station_names, num_rows_to_create, outfile):
    """
    ...
    print(f"Test data successfully written to {outfile}")
...
def main():
    ...
    build_test_data(weather_station_names, num_rows_to_create, outfile)
